...
[assembly: MelonInfo(typeof(SprocketModAPI.ApiMod), "Sprocket Mod API", "0.2.0-fix1", "furryAxw")]
...
namespace SprocketModAPI
{
    ...
    public sealed class ApiMod : MelonMod
    {
        ...
        public override void OnInitializeMelon()
        {
            ...
            LoggerInstance.Msg("Sprocket Mod API 0.2.0-fix1 initialized (API 1.1).");
        }
